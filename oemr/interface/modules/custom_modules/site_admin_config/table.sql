...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`, `codes`, `activity`) VALUES
  ('state', 'ZA_WC', 'Western Cape (Cape Town)', 502, 0, 0, 'ZA', '', '', 1),
  ('state', 'ZA_KZN', 'KwaZulu-Natal (Durban)', 503, 0, 0, 'ZA', '', '', 1),
  ('state', 'ZA_EC', 'Eastern Cape', 504, 0, 0, 'ZA', '', '', 1),
  ('state', 'NG_LA', 'Lagos', 510, 0, 0, 'NG', '', '', 1),
  ('state', 'NG_FC', 'Federal Capital Territory (Abuja)', 511, 0, 0, 'NG', '', '', 1),
  ('state', 'NG_KN', 'Kano', 512, 0, 0, 'NG', '', '', 1),
  ('state', 'NG_RI', 'Rivers (Port Harcourt)', 513, 0, 0, 'NG', '', '', 1),
  ('state', 'KE_NBO', 'Nairobi County', 520, 0, 0, 'KE', '', '', 1),
  ('state', 'KE_MBA', 'Mombasa County', 521, 0, 0, 'KE', '', '', 1),
  ('state', 'KE_KIS', 'Kisumu County', 522, 0, 0, 'KE', '', '', 1),
  ('state', 'KE_KIA', 'Kiambu County', 523, 0, 0, 'KE', '', '', 1),
  ('state', 'GH_AA', 'Greater Accra', 530, 0, 0, 'GH', '', '', 1),
  ('state', 'GH_AH', 'Ashanti (Kumasi)', 531, 0, 0, 'GH', '', '', 1),
  ('state', 'EG_CAI', 'Cairo Governorate', 540, 0, 0, 'EG', '', '', 1),
  ('state', 'EG_ALX', 'Alexandria Governorate', 541, 0, 0, 'EG', '', '', 1),
  ('state', 'AU_NSW', 'New South Wales', 601, 0, 0, 'AU', '', '', 1),
  ('state', 'AU_VIC', 'Victoria', 602, 0, 0, 'AU', '', '', 1),
  ('state', 'AU_QLD', 'Queensland', 603, 0, 0, 'AU', '', '', 1),
  ('state', 'AU_WA', 'Western Australia', 604, 0, 0, 'AU', '', '', 1),
  ('state', 'AU_SA', 'South Australia', 605, 0, 0, 'AU', '', '', 1),
  ('state', 'AU_TAS', 'Tasmania', 606, 0, 0, 'AU', '', '', 1),
  ('state', 'AU_ACT', 'Australian Capital Territory', 607, 0, 0, 'AU', '', '', 1),
  ('state', 'AU_NT', 'Northern Territory', 608, 0, 0, 'AU', '', '', 1),
  ('county', 'FL_MIAMI_DADE', 'Miami-Dade County', 1, 0, 0, 'FL', '', '', 1),
  ('county', 'FL_BROWARD', 'Broward County', 2, 0, 0, 'FL', '', '', 1),
  ('county', 'FL_PALM_BEACH', 'Palm Beach County', 3, 0, 0, 'FL', '', '', 1),
  ('county', 'FL_ORANGE', 'Orange County', 4, 0, 0, 'FL', '', '', 1),
  ('county', 'FL_HILLSBOROUGH', 'Hillsborough County', 5, 0, 0, 'FL', '', '', 1),
  ('county', 'CA_LOS_ANGELES', 'Los Angeles County', 10, 0, 0, 'CA', '', '', 1),
  ('county', 'CA_ORANGE', 'Orange County', 11, 0, 0, 'CA', '', '', 1),
  ('county', 'CA_SAN_DIEGO', 'San Diego County', 12, 0, 0, 'CA', '', '', 1),
  ('county', 'CA_SANTA_CLARA', 'Santa Clara County', 13, 0, 0, 'CA', '', '', 1),
  ('county', 'CA_SAN_FRANCISCO', 'San Francisco County', 14, 0, 0, 'CA', '', '', 1),
  ('county', 'NY_NEW_YORK', 'New York County (Manhattan)', 20, 0, 0, 'NY', '', '', 1),
  ('county', 'NY_KINGS', 'Kings County (Brooklyn)', 21, 0, 0, 'NY', '', '', 1),
  ('county', 'NY_QUEENS', 'Queens County', 22, 0, 0, 'NY', '', '', 1),
  ('county', 'NY_BRONX', 'Bronx County', 23, 0, 0, 'NY', '', '', 1),
  ('county', 'NY_NASSAU', 'Nassau County', 24, 0, 0, 'NY', '', '', 1),
  ('county', 'TX_HARRIS', 'Harris County (Houston)', 30, 0, 0, 'TX', '', '', 1),
  ('county', 'TX_DALLAS', 'Dallas County', 31, 0, 0, 'TX', '', '', 1),
  ('county', 'TX_TARRANT', 'Tarrant County (Fort Worth)', 32, 0, 0, 'TX', '', '', 1),
  ('county', 'TX_TRAVIS', 'Travis County (Austin)', 33, 0, 0, 'TX', '', '', 1),
  ('county', 'TX_BEXAR', 'Bexar County (San Antonio)', 34, 0, 0, 'TX', '', '', 1),
  ('county', 'IN_MUMBAI', 'Mumbai District', 40, 0, 0, 'IN_MH', '', '', 1),
  ('county', 'IN_PUNE', 'Pune District', 41, 0, 0, 'IN_MH', '', '', 1),
  ('county', 'IN_NAGPUR', 'Nagpur District', 42, 0, 0, 'IN_MH', '', '', 1),
  ('county', 'IN_THANE', 'Thane District', 43, 0, 0, 'IN_MH', '', '', 1),
  ('county', 'IN_BLR_URBAN', 'Bengaluru Urban', 44, 0, 0, 'IN_KA', '', '', 1),
  ('county', 'IN_MYSURU', 'Mysuru District', 45, 0, 0, 'IN_KA', '', '', 1),
  ('county', 'IN_CHENNAI', 'Chennai District', 46, 0, 0, 'IN_TN', '', '', 1)
ON DUPLICATE KEY UPDATE `title` = VALUES(`title`), `seq` = VALUES(`seq`), `mapping` = VALUES(`mapping`), `activity` = VALUES(`activity`);

INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`, `codes`, `activity`) VALUES
  ('county', 'IN_HYDERABAD', 'Hyderabad District', 47, 0, 0, 'IN_TG', '', '', 1),
  ('county', 'IN_AHMEDABAD', 'Ahmedabad District', 48, 0, 0, 'IN_GJ', '', '', 1),
  ('county', 'AE_DXB_DEIRA', 'Deira', 50, 0, 0, 'AE_DXB', '', '', 1),
  ('county', 'AE_DXB_BURDUBAI', 'Bur Dubai', 51, 0, 0, 'AE_DXB', '', '', 1),
  ('county', 'AE_DXB_DOWNTOWN', 'Downtown / Business Bay', 52, 0, 0, 'AE_DXB', '', '', 1),
  ('county', 'AE_DXB_JUMEIRAH', 'Jumeirah', 53, 0, 0, 'AE_DXB', '', '', 1),
  ('county', 'AE_AUH_CITY', 'Abu Dhabi City Central', 54, 0, 0, 'AE_AUH', '', '', 1),
  ('county', 'AE_AUH_ALAIN', 'Al Ain Region', 55, 0, 0, 'AE_AUH', '', '', 1),
  ('county', 'AE_AUH_DHAFRA', 'Al Dhafra Region', 56, 0, 0, 'AE_AUH', '', '', 1),
  ('county', 'AU_SYDNEY', 'Greater Sydney', 60, 0, 0, 'AU_NSW', '', '', 1),
  ('county', 'AU_HUNTER', 'Hunter Region', 61, 0, 0, 'AU_NSW', '', '', 1),
  ('county', 'AU_MELBOURNE', 'Greater Melbourne', 62, 0, 0, 'AU_VIC', '', '', 1),
  ('county', 'AU_GEELONG', 'Geelong', 63, 0, 0, 'AU_VIC', '', '', 1),
  ('county', 'AU_BRISBANE', 'Greater Brisbane', 64, 0, 0, 'AU_QLD', '', '', 1),
  ('county', 'AU_GOLDCOAST', 'Gold Coast', 65, 0, 0, 'AU_QLD', '', '', 1),
  ('county', 'AU_PERTH', 'Perth Metropolitan', 66, 0, 0, 'AU_WA', '', '', 1)
ON DUPLICATE KEY UPDATE `title` = VALUES(`title`), `seq` = VALUES(`seq`), `mapping` = VALUES(`mapping`), `activity` = VALUES(`activity`);

-- ============================================================================
-- 17. Client-Side Location Cascading Dropdowns Script
-- ============================================================================
